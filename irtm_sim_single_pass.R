...
tpartname = "irtm_time_partial_.rds"
ppartname = "irtm_params_partial_.rds"
rpartname = "irtm_res_partial_.rds"
...
for(i in 1:nrow(single_pass_no_dupes)){ ## open for loop
  ...
  run_time <- c(run_time, irtm = as.numeric(difftime(irtm_end, irtm_start, units="secs")))
  print(paste0("run_time: ", run_time))
...
## Save
rname = paste0("irtm_results_single_pass.rds")
tname = paste0("irtm_time_single_pass.rds")
pname = paste0("irtm_params_single_pass.rds")
