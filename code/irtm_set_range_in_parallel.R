...
source('source/helpers.R') ## mse, custom plots
source('source/cfa_model_syntax.R') ## script to format CFA model input
source('source/format_cfa_lambda.R') ## script to format CFA loadings
source('source/blavPredict_format_conversion.R') #script to format blavaan samples
source('source/irtm_sims_gen_data.R') ## script to generate data
source('source/irtm_bsem_results_to_df.R') ## script to format list of results as single df

## Make names to save partial `results:
##  

tpartname = "simulations/irtm_bcfa_bsem_time_partial_set.rds"
ppartname = "simulations/irtm_bcfa_bsem_params_partial_set.rds"
rpartname = "simulations/irtm_bcfa_bsem_res_partial_set.rds"
...
## Save
rname = paste0("simulations/irtm_bcfa_bsem_results_single_pass_set.rds")
tname = paste0("simulations/irtm_bcfa_bsem_time_single_pass_set.rds")
pname = paste0("simulations/irtm_bcfa_bsem_params_single_pass_set.rds")
