...
## This is the initial run, with a single specification for the 
...
sname = paste0("small_sim_params", ".rds")
...
## Save results
fname = paste0("irtm_bcfa_bsem_N100K10.rds")
save(all_results, file=fname)

## save time info
tname = paste0("irtm_bcfa_bsem_N100K10_time.rds")
